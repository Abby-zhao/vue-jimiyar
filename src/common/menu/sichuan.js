const basic = [
  ...
  {
    icon: 'el-icon-tickets',
    index: 'dispatchUnitManageSc',
    title: '调度单元管理'
  },
  {
    icon: 'el-icon-tickets',
    index: 'dispatchUnitGenRelationSc',
    title: '调度单元与机组对应关系'
  },
  {
    icon: 'el-icon-tickets',
    index: 'dispatchPowerGenRelationSc',
    title: '调度电厂与机组对应关系'
  },
  // {
  //   icon: 'el-icon-tickets',
...
const cgkzs = [
  ...
  //     {
  //       index: 'group',
  //       title: '常规可再生能源发电项目-集团'
  //     },
  //     {
  //       index: 'proCompany',
  //       title: '常规可再生能源发电项目-省公司'
  //     },
  //     {
  //       index: 'basicLevel',
  //       title: '常规可再生能源发电项目-基层单位'
  //     }
  //   ]
  // },
  // {
